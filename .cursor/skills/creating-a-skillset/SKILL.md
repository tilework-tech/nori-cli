...
5. Check the scope. Verify that the ask is good for a skillset.
  ...
  - If too specific, ask me if I want to make a skill instead. If so, use `/home/amol/code/nori/nori-cli/.worktrees/fix-rows/.cursor/skills/creating-skills/SKILL.md`.
...
8. If I identified specific subprocesses that should be skills, create those skills using the `/home/amol/code/nori/nori-cli/.worktrees/fix-rows/.cursor/skills/creating-skills/SKILL.md` skill.
...
- Read `/home/amol/code/nori/nori-cli/.worktrees/fix-rows/.cursor/skills/using-skills/SKILL.md`

// followed by step by step instructions on what to do next, e.g.
// 'ask me to choose between foo, bar, and baz'
// 'if condition, read and follow  `/home/amol/code/nori/nori-cli/.worktrees/fix-rows/.cursor/skills/{skill name}/SKILL.md`'
// 'do abc'
</required>
