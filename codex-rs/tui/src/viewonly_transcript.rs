...
use crate::client_event_format::format_approval_header;
use crate::client_event_format::format_artifacts;
use crate::client_event_format::format_invocation;
use crate::client_event_format::format_plan_status;
...
fn format_client_event(event: &nori_protocol::ClientEvent) -> Option<String> {
    match event {
        ...
        nori_protocol::ClientEvent::ToolSnapshot(tool_snapshot) => Some(format_tool_event(
            format_tool_header(tool_snapshot),
        ...
        nori_protocol::ClientEvent::ApprovalRequest(approval) => {
            ...
            Some(format_tool_event(
                format_approval_header(approval),
                &snapshot.invocation,
                &snapshot.artifacts,
            ))
        }
