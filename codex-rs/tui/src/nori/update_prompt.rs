...
//!
//! This module provides the update prompt screen for Nori CLI,
//! with Nori-specific branding and URLs.
...
pub(crate) async fn run_update_prompt_if_needed(
    ...
    let Some(update_action) = super::update_action::get_update_action() else {
        return Ok(UpdatePromptOutcome::Continue);
    };
