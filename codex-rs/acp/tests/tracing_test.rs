...
fn test_rolling_file_tracing_comprehensive() {
    ...
    let result1 = codex_acp::init_rolling_file_tracing(&log_dir, "nori-acp");
    ...
    let result2 = codex_acp::init_rolling_file_tracing(&log_dir, "nori-acp");
    assert!(
        result2.is_err(),
    ...
    let result3 = codex_acp::init_file_tracing(&legacy_path);
    assert!(
        result3.is_err(),
