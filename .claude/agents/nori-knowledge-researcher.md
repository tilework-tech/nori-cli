...
- **Recall**: Query the Nori knowledge base. This contains all information stored across the team, and is a critical first entry point. You should always do a Recall query first. Read `/home/clifford/Documents/source/nori/cli/.claude/skills/recall/SKILL.md` for usage instructions, then execute via Bash.
- **Memorize**: Save insights. Read `/home/clifford/Documents/source/nori/cli/.claude/skills/memorize/SKILL.md` for usage instructions, then execute via Bash.
...
2. <required>You MUST use the **Recall** skill (/home/clifford/Documents/source/nori/cli/.claude/skills/recall/SKILL.md) at least one time to search for relevant articles.</required>
